...
Follow the journey <a href='https://techzone.ibm.com/collection/apollo-business-automation/journey--archive' target = '_blank'>Apollo Business Automation - CP4BA Demos</a> to reserve your environment on IBM TechZone. It consists of three major steps:
