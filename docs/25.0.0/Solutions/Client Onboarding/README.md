# Jam-in-a-Box - Single User Environment for CP4BA 25.0.0 (coming soon)
...
>
> If you have your own Cloud Pak for Business Automation (CP4BA) 25.0.0 environment and can't use RDP, please refer to this [document](../../README.md) and this [document](README_2500_SelfDeploy.md) for other options.
