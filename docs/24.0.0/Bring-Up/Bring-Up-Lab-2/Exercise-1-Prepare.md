...
The preparation of a bastion host is discussed in the documentation on this page: <a href='https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/24.0.0?topic=deployment-preparing-client-connect-cluster' target = '_blank'>Preparing a client to connect to the cluster</a>.
...
1. Check that you have an entitlement key with the proper image access. For this, please open <a href='https://myibm.ibm.com/products-services/containerlibrary' target = '_blank'>IBM Container Library</a>. Log in with your IBM ID. IBMers can use their w3 ID.
